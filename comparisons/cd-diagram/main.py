...
def wilcoxon_holm(alpha=0.05, df_perf=None):
    ...
    print("rank_data shape:", rank_data.shape)  
    print("Number of classifiers:", len(np.sort(classifiers)))  
    print("Number of unique dataset names:", len(np.unique(sorted_df_perf['dataset_name'])))
...
df_perf = pd.read_csv('result.csv', index_col=False)
